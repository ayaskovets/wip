...
TEST_P(net_socket_base_sockaddr, copy) {
  const auto& family = GetParam();
  const core::net::sockets::base_sockaddr original(family);
  const core::net::sockets::base_sockaddr copy(original);
...
TEST_P(net_socket_base_sockaddr, move) {
  const auto& family = GetParam();
  core::net::sockets::base_sockaddr original(family);
  const core::net::sockets::base_sockaddr move(std::move(original));
...
INSTANTIATE_TEST_SUITE_P(net_socket_base_sockaddr, net_socket_base_sockaddr,
                         ::testing::Values(core::net::sockets::family::kInet,
                                           core::net::sockets::family::kInet6,
                                           core::net::sockets::family::kUnix),
                         ([](const testing::TestParamInfo<
                              net_socket_base_sockaddr::ParamType>& info) {
